    ...
    return {
        init: function() {
            ...
            $('#form-validation').validate({
                ...
                messages: {
                    val_username: {
                        required: 'Kullanıcı adını yazınız',
                        minlength: '3 harften kıs olamaz.'
                    },
                    val_email: 'Please enter a valid email address',
                    val_password: {
                        required: 'Şifresinizi oluşturunuz',
                        minlength: '5 Karakterden az olamaz'
                    },
                    val_confirm_password: {
                        required: 'Şifresinizi oluşturunuz',
                        minlength: '5 Karakterden uzun olmalıdır',
                        equalTo: 'Şifrleriniz aynı olmalı'
                    },
